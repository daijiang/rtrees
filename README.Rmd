...
**`rtrees` just got an important update to speed it up! Please try to install the latest version. If you see any problem, please file a GitHub issue. Thanks!**
...
Currently, `rtrees` provides mega-trees for the following taxonomic groups: amphibian, bird, fish, mammal, plant, reptile, and shark_ray. The mega-trees (or subset of 100 posterior phylogenies; 50 for fish to reduce the package size) are stored as GitHub release assets in the data package [{megatrees}](https://github.com/daijiang/megatrees) and downloaded on demand via getter functions.
...
Li Daijiang. (2023). [rtrees: an R package to assemble phylogenetic trees from megatrees](https://nsojournals.onlinelibrary.wiley.com/doi/10.1111/ecog.06643). Ecography. e06643
