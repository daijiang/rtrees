...
coverage_tb = data.frame(
  ...
  Mega_tree = c("`tree_plant_otl` (74,531 tips)", 
                "`tree_fish` (11,638 tips)", 
                "`tree_bird_ericon`, `tree_bird_hackett` (9,993 tips)",
                "`tree_mammal` (5,831 tips)"),
...
It is also possible to specify a particular speices to bind with by specifing columns `close_sp` and/or `close_genus`.
...
- The default scenario is `S1`, which will graft species at the genus/family basal node.
  ...
  + `S3` will graft the new tip above the genus/family basal node if no co-family species found.
...
This package is still in very early stage. Feel free to test it. Contributions and suggestions are welcome.
